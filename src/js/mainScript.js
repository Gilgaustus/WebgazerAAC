...
async function init() {
    ...
    if (gridsetFilename) {
        ...
        let matchingUserConfig = autoUserSettings.find(
            (settings) => settings.originGridsetFilename === gridsetFilename
        );
...
function initServiceWorker() {
    ...
    if (constants.SUPPORTS_SERVICE_WORKER) {
        ...
        MainVue.setTooltipAfterNavigation('browserNotSupportingOfflineMode', {
            msgType: 'warn',
            translate: true,
            timeout: 15000
        });
